                ...
                <tr>
                    <td style="padding: 20px;">
                        ...
                        <table width="100%" cellpadding="8" cellspacing="0" style="margin-top: 20px; border-collapse: collapse;">
                            ...
                            <tr>
                                <th align="left" style="border-bottom: 1px solid #ddd; padding: 10px;">Assignee</th>
                                <td align="left" style="border-bottom: 1px solid #ddd; padding: 10px;">{{ $details['assignee'] }}</td>
                            </tr>
                            <tr>
