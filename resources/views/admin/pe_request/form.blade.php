...
{{--    <script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=u0nqw6bdnhchs7yky70br91x6sl6ja1nc4hor8asbmv2ie3a"></script>--}}
    ...
    <section class="section">
        ...
        <div class="section-header">
            <h1>DISPLAY & PE Request</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{ url('admin/project') }}">DISPLAY & PE Request</a></div>
                <div class="breadcrumb-item active">DISPLAY & PE Request</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">DISPLAY & PE Request</h2>
            <div class="row">
                <div class="col-lg-7">
                    <div class="card">
                    ...
                    @if(!empty($request_type_list))
                        ...
                        <?php foreach ($request_type_list as $task): ?>
                            ...
                            <div class="card assets_existing">
                                ...
                                ?>
                                <div class="clearfix" id="{{$task->pe_request_type_id}}" style="border-left: 10px solid {{ $left_border_color }}; border-radius: 20px;">

                                    <div class="asset--grid-row">

                                        <div class="project-info">
                                            <ul class="project-info-list">
                                                <li><strong>{{ strtoupper(str_replace('_', ' ', $task->request_type)) }} #{{ $task->pe_request_type_id }}</strong> </li>
                                                ...
                                                <li><h5><span class="badge badge-dark">{{ ucwords(str_replace('_', ' ', $task->task_category)) }}</span></h5></li>
                                                <?php } ?>
                                        ...
                                        <ul class="project-members-list" style="padding-left: 70px;">
                                            ...
                                            <?php if($task->assignee_first_name != null){ ?>
                                            <li><strong>Assignee :</strong> <span class="assignee-bg">{{ $task->assignee_first_name }} {{ $task->assignee_last_name }}</span></li>
                                            <?php } ?>
                                            ...
                                            <div class="project-action-icons">
                                                <ul class="project-icons">
                                                    <li>
                                                        ...
                                                        class="close"
                                                        data-id=""
                                                        data-pe-request-type-id="{{ $task->pe_request_type_id }}"
                                                        data-pe-request-type="{{ $task->request_type }}"
                                                        onclick="delete_pe_request_type($(this));">
                                    ...
                                    <div style="text-align: center;">
                                        <i id="arrow-{{$task->pe_request_type_id}}" class="dropdown fa-lg fa fa-angle-down" onclick="click_arrow(this, {{$task->pe_request_type_id}})"></i>
                                    </div>

                                    <div id="asset-id-{{$task->pe_request_type_id}}" class="box-body form_creator" data-asset-id="{{ $task->pe_request_type_id }}" style="display: none">
                                        <section>
                                            <div class="inner_box">
                                                <?php $data = [$task, $task->files]; ?>
                                                @include('admin.pe_request.'.$task->request_type, $data)
                                            </div>
                                        </section>
                                    </div>
                    ...
                    @if(!empty($project))
                        <?php if(Auth::user()->function == 'Product' || Auth::user()->function == 'Marketing' || Auth::user()->function == 'Admin' || Auth::user()->team == 'Display (D&P)') {?>

                        <div class="clearfix" id="asset_selector" style="display: block">
                        <div class="card box asset box-primary">
                            <div class="card-header" id="pe_bg" style="height: 500px;">
                                <div class="row" style="display: flex; justify-content: center; padding: 5px 0 0 0;">
                                    <div id="add_task_btn" style="display: block">
                                        <a class="btn-lg btn-secondary add-row" style="color: #050000; background-color: #cdd3d8; border-radius: 1.25rem;" onclick="click_task_add_btn()">Add <b style="color: #b91d19;">DISPLAY & PE REQUEST</b> Type</a>
                                    </div>
                                </div>
                                        ...
                                        <div class="inner_box">
                                            <div class="form-group">
                                                ...
                                                <span class="float-right">
                                                    <a href="{{ url('admin/pe_request/'. $project->id .'/edit') }}">
                                                ...
                                                <select name="add_task_type" id="add_request_type" class="form-control" onchange="select_request_type()">
                                                    ...
                                                    <option value="engineering_drawing">Engineering (3D) Drawing</option>
                                            ...
                                            <div id="new_display" style="display: none;">
                                                @include('admin.pe_request.new.display')
                                            </div>
                                            <div id="new_engineering_drawing" style="display: none;">
                                                @include('admin.pe_request.new.engineering_drawing')
                                            </div>
                                            <div id="new_sample" style="display: none;">
                                                @include('admin.pe_request.new.sample')
                                            </div>
                                            <div id="new_mold" style="display: none;">
                                                @include('admin.pe_request.new.mold')
                                            </div>
                                        </div>
                                    </section>
                                </div>
                            ...
                            <div class="col">
                                <section id="add_note" class="notes" style="display: none;">
                                    ...
                                    <div class="write note">
                                        <form method="POST" action="{{ route('pe_request.add_note') }}" enctype="multipart/form-data">
                                            @csrf
    ...
    <script type="text/javascript">
        ...
        function select_request_type(){
            ...
            if(request_type == 'display'){
                $("#new_display").fadeIn(600);
                $("#new_sample").fadeOut();
                $("#new_mold").fadeOut();
            }else if(request_type == 'engineering_drawing'){
                $("#new_display").fadeOut();
                $("#new_engineering_drawing").fadeIn(600);
                $("#new_sample").fadeOut();
                $("#new_mold").fadeOut();
            }else if(request_type == 'sample'){
                $("#new_display").fadeOut();
                $("#new_engineering_drawing").fadeOut();
                $("#new_sample").fadeIn(600);
                $("#new_mold").fadeOut();
            }else if(request_type == 'mold'){
                $("#new_display").fadeOut();
                $("#new_engineering_drawing").fadeOut();
                $("#new_sample").fadeOut();
                $("#new_mold").fadeIn(600);
        ...
        function delete_pe_request_type(el) {
            if (confirm("Are you sure to Delete? Are you sure you want to delete? Once deleted, this action cannot be undone and the data will no longer be accessible.") == true) {
                let id = $(el).attr('data-pe-request-type-id');
                let type = $(el).attr('data-pe-request-type');
                $.ajax({
                    url: "<?php echo url('/admin/pe_request/requestTypeRemove'); ?>"+"/"+id+"/"+type,
                    type: "GET",
                    datatype: "json",
        ...
        function remove_file(el) {
            if (confirm("Are you sure to Delete File?") == true) {
                ...
                $.ajax({
                    url: "<?php echo url('/admin/pe_request/fileRemove'); ?>"+"/"+id,
                    type: "GET",
                    datatype: "json",
                    success: function(response) {
                        if(response == 'success'){
        ...
        function action_resubmit(el){
            ...
            if (confirm("Ensure all changes are saved before resubmitting.") == true) {
                ...
                $.ajax({
                    url: "<?php echo url('/admin/pe_request/actionReSubmit'); ?>"+"/"+id,
                    type: "GET",
                    datatype: "json",
                    success: function(response) {
                        if(response != 'fail'){
        ...
        function action_start(el){
            ...
            if (confirm("Your request status will change to 'In Progress'") == true) {
                ...
                $.ajax({
                    url: "<?php echo url('/admin/pe_request/actionInProgress'); ?>"+"/"+id,
                    type: "GET",
                    datatype: "json",
                    success: function(response) {
                        if(response != 'fail'){
        ...
        function action_review(el){
            ...
            if (confirm("The work has been updated for review, and the status will now change to 'Action Review'.") == true) {
                let id = $(el).attr('data-request-type-id');
                $.ajax({
                    url: "<?php echo url('/admin/pe_request/actionReview'); ?>"+"/"+id,
                    type: "GET",
                    datatype: "json",
                    success: function(response) {
                        if(response != 'fail'){
        ...
        function action_complete(el){
            ...
            if (confirm("The request is now complete, and no further changes can be made.") == true) {
                let id = $(el).attr('data-request-type-id');
                $.ajax({
                    url: "<?php echo url('/admin/pe_request/actionComplete'); ?>"+"/"+id,
                    type: "GET",
                    datatype: "json",
                    success: function(response) {
                        if(response != 'fail'){
        ...
        function action_approve(el){
            ...
            if (confirm("Are you sure to Action Approve?") == true) {
                let id = $(el).attr('data-request-type-id');
                $.ajax({
                    url: "<?php echo url('/admin/pe_request/actionApprove'); ?>"+"/"+id,
                    type: "GET",
                    datatype: "json",
                    success: function(response) {
                        if(response != 'fail'){
