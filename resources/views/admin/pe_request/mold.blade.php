...
<form method="POST" action="{{ route('pe_request.edit_mold', $pe_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mold">
        ...
        <?php }?>
            ...
            <p style="color: #222; text-align: center; font-weight: bold;">Mold</p>

            <div class="form-group">
                <label>Request Detail: </label>
                <textarea class="form-control" style="height:100px;"
                          name="request_detail" required>{{ $data[0]->request_detail }}</textarea>
{{--                {!! Form::textarea('request_detail', !empty($data[0]) ? $data[0]->request_detail : null, ['class' => 'form-control summernote']) !!}--}}
            </div>

            <div class="form-group">
                <label>Total Quantity:</label>
                <input type="text" name="total_quantity" class="form-control" value="{{ $data[0]->total_quantity }}" required>
            </div>

            <div class="form-group">
                <label>Item Number for Molded Part:</label>
                <input type="text" name="item_number" class="form-control" value="{{ $data[0]->item_number }}" required>
            </div>

            <div class="form-group">
                <label>Color & Pattern #:</label>
                <textarea class="form-control" id="color_pattern" name="color_pattern" style="height: 100px;" required>{{ $data[0]->color_pattern }}</textarea>
            </div>

            <div class="form-group">
                <label>Tooling Budget Code:</label>
                <input type="text" name="tooling_budget_code" class="form-control" value="{{ $data[0]->tooling_budget_code }}" required>
            </div>
...
{{--                </div>--}}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Mold Design Start Date:</label>
                            <input type="text" name="mold_design_start_date" id="{{ $pe_request_type_id }}_mold_design_start_date" placeholder="Mold Design Start Date" autocomplete="off"
                                   class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Mold Design Finish Date:</label>
                            <input type="text" name="mold_design_finish_date" id="{{ $pe_request_type_id }}_mold_design_finish_date" placeholder="Mold Design Finish Date" autocomplete="off"
                                   class="form-control"
                                   value="{{ !empty($data[0]->mold_design_finish_date) ? $data[0]->mold_design_finish_date : null }}">
                        </div>
                    </div>
                </div>

{{--                <div class="form-group">--}}
{{--                    <label>Revision Cnt. (M/D):</label>--}}
{{--                    <input type="text" name="revision_cnt_md" class="form-control" value="{{ !empty($data[0]->revision_cnt_md) ? $data[0]->revision_cnt_md : null }}">--}}
{{--                </div>--}}

{{--                <div class="form-group">--}}
{{--                    <label>Revising (M/D):</label>--}}
{{--                    <input type="text" name="revising_md" class="form-control" value="{{ !empty($data[0]->revising_md) ? $data[0]->revising_md : null }}">--}}
{{--                </div>--}}

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>CAM Start Date:</label>
                            <input type="text" name="cam_start_date" id="{{ $pe_request_type_id }}_cam_start_date" placeholder="CAM Start Date" autocomplete="off"
                                   class="form-control"
                                   value="{{ !empty($data[0]->cam_start_date) ? $data[0]->cam_start_date : null }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>CAM Finish Date:</label>
                            <input type="text" name="cam_finish_date" id="{{ $pe_request_type_id }}_cam_finish_date" placeholder="CAM Finish Date" autocomplete="off"
                                   class="form-control"
                                   value="{{ !empty($data[0]->cam_finish_date) ? $data[0]->cam_finish_date : null }}">
                        </div>
                    </div>
                </div>

{{--                <div class="form-group">--}}
{{--                    <label>Revision Cnt. (CAM):</label>--}}
{{--                    <input type="text" name="revision_cnt_cam" class="form-control" value="{{ !empty($data[0]->revision_cnt_cam) ? $data[0]->revision_cnt_cam : null }}">--}}
{{--                </div>--}}

{{--                <div class="form-group">--}}
{{--                    <label>Revising (CAM):</label>--}}
{{--                    <input type="text" name="revising_cam" class="form-control" value="{{ !empty($data[0]->revising_cam) ? $data[0]->revising_cam : null }}">--}}
{{--                </div>--}}

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>C&C Start Date:</label>
                            <input type="text" name="machining_start_date" id="{{ $pe_request_type_id }}_machining_start_date" placeholder="Machining Start Date" autocomplete="off"
                                   class="form-control"
                                   value="{{ !empty($data[0]->machining_start_date) ? $data[0]->machining_start_date : null }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>C&C Finish Date:</label>
                            <input type="text" name="machining_finish_date" id="{{ $pe_request_type_id }}_machining_finish_date" placeholder="Machining Finish Date" autocomplete="off"
                                   class="form-control"
                                   value="{{ !empty($data[0]->machining_finish_date) ? $data[0]->machining_finish_date : null }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="machining_cost" class="form-control" value="{{ !empty($data[0]->machining_cost) ? $data[0]->machining_cost : null }}">
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(function() {
        $('input[id="<?php echo $pe_request_type_id;?>_mold_design_start_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        <?php if($data[0]->mold_design_start_date == null){ ?>
        $('input[id="<?php echo $pe_request_type_id; ?>_mold_design_start_date"]').val('');
        <?php } ?>
    });
    $(function() {
        $('input[id="<?php echo $pe_request_type_id;?>_mold_design_finish_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        <?php if($data[0]->mold_design_finish_date == null){ ?>
        $('input[id="<?php echo $pe_request_type_id; ?>_mold_design_finish_date"]').val('');
        <?php } ?>
    });
    $(function() {
        $('input[id="<?php echo $pe_request_type_id;?>_cam_start_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        <?php if($data[0]->cam_start_date == null){ ?>
        $('input[id="<?php echo $pe_request_type_id; ?>_cam_start_date"]').val('');
        <?php } ?>
    });
    $(function() {
        $('input[id="<?php echo $pe_request_type_id;?>_cam_finish_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        <?php if($data[0]->cam_finish_date == null){ ?>
        $('input[id="<?php echo $pe_request_type_id; ?>_cam_finish_date"]').val('');
        <?php } ?>
    });
    $(function() {
        $('input[id="<?php echo $pe_request_type_id;?>_machining_start_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        <?php if($data[0]->machining_start_date == null){ ?>
        $('input[id="<?php echo $pe_request_type_id; ?>_machining_start_date"]').val('');
        <?php } ?>
    });
    $(function() {
        $('input[id="<?php echo $pe_request_type_id;?>_machining_finish_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        <?php if($data[0]->machining_finish_date == null){ ?>
        $('input[id="<?php echo $pe_request_type_id; ?>_machining_finish_date"]').val('');
        <?php } ?>
    });
</script>
