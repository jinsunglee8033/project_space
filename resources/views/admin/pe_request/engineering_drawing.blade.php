...
<form method="POST" action="{{ route('pe_request.edit_engineering_drawing', $pe_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="engineering_drawing">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">Engineering (3D) Drawing</p>
...
{{--            <?php if (!empty($data[0]) && $data[0]->status == 'action_requested' && (auth()->user()->role == 'Admin' || auth()->user()->role == 'Team Lead') ) { ?>--}}
...
{{--            <?php } ?>--}}
{{--            <div class="form-group">--}}
{{--                <label>Revision Cnt. (E/D):</label>--}}
{{--                <input type="text" name="revision_cnt_ed" class="form-control" value="{{ !empty($data[0]->revision_cnt_ed) ? $data[0]->revision_cnt_ed : null }}">--}}
{{--            </div>--}}

{{--            <div class="form-group">--}}
{{--                <label>Revising (E/D):</label>--}}
{{--                <input type="text" name="revising_ed" class="form-control" value="{{ !empty($data[0]->revising_ed) ? $data[0]->revising_ed : null }}">--}}
{{--            </div>--}}
