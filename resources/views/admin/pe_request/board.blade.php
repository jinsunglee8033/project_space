...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>DISPLAY & PE Request Status Board</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">DISPLAY & PE Request Status Board</div>
            </div>
        </div>

        <div class="section-body">

            @include('admin.pe_request._filter_board')
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($task_list_action_requested as $task)
                        ...
                        <div class="card" style="{{$late_css}}">
                            <a href="{{ url('admin/pe_request/'. $task->project_id .'/edit#'.$task->pe_request_type_id)}}" style="text-decoration: none;">
                                <div class="card-body" style="margin: 0px -5px -20px -5px;">
                                    <div class="media" style="padding-bottom: 0px;">
                                        <div class="form-group" style="width: 100%;">
                                            ...
                                            <?php } ?>
                                            <?php if($task->request_type == 'display') {
                                                $bg_type = '#D733FF';
                                            }else if($task->request_type == 'engineering_drawing'){
                                                $bg_type = '#0C67EA';
                                            }else if($task->request_type == 'sample'){
                                                $bg_type = '#FF9331';
                                            }else{
                                                $bg_type = '#FF332E';
                                            }
                                            ...
                                            <div style="float:left; padding-left: 10px; color: {{$bg_type}};">
                                                {{ strtoupper($task->request_type) }} | {{$task->pe_request_type_id}}
                                            </div>
                                            <div style="float: right; color: #333333;" >
                    ...
                    @foreach ($task_list_in_progress as $task)
                        ...
                        <?php
                            if(isset($task->task_category) &&
                                ($task->task_category == 'Production (In-house)'
                                    || $task->task_category == 'Production (Outside-Local)'
                                        || $task->task_category == 'Production (Outside-Oversea)') ) {
