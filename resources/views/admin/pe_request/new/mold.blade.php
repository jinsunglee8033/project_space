<?php $request_type = 'mold'; ?>

<form method="POST" action="{{ route('pe_request.add_mold') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mold">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">Mold</p>
