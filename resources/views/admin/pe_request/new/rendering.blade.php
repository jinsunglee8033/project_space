<?php $request_type = 'rendering'; ?>

<form method="POST" action="{{ route('pe_request.add_rendering') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="rendering">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">Rendering</p>
