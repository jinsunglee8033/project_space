...
<form method="POST" action="{{ route('ra_request.edit_canada_launch', $ra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="canada_launch">
        ...
        <?php }?>
            ...
            <p style="color: #222; text-align: center; font-weight: bold;">CANADA LAUNCH</p>
            ...
            <div class="form-group">
                <label>Requested Due Date: <b style="color: #b91d19">(Select from the calendar)</b></label>
        ...
        <div class="form-group">
            ...
            <div style="background-color: #e9e9e9; padding: 10px 10px 10px 10px; margin: 0 0 10px 0;">
                ...
                <div class="form-group">
                    <label>Est. Registration Due Date: <b style="color: #b91d19">(The request will take 3 business days to complete from the date of CNF submission by RA, unless it requires an in-depth review by Health Canada.)</b></label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="registration_number" class="form-control" value="{{ $data[0]->formula }}">
                </div>
    ...
    <div class="form-group">
        ...
        <input type="submit" name="submit" value="Save" style="margin-top:10px; font-size: large" class="btn btn-lg btn-primary submit"/>
            <label style="font-size: medium; font-weight:100; color: #b91d19; padding: 0 0 0 20px;"><b>* All changes must be saved before clicking any action buttons.</b></label>
        <br>
        <input type="button"
               name="RA revision"
               value="Revision"
