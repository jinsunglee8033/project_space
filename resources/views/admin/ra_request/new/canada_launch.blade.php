<?php $request_type = 'canada_launch'; ?>

<form method="POST" action="{{ route('ra_request.add_canada_launch') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_wercs">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">CANADA LAUNCH (CNF)</p>
        ...
        <div class="form-group">
            <label>Requested Due Date: <b style="color: #b91d19">(The request will take 3 business days to complete from the date of CNF submission by RA, unless it requires an in-depth review by Health Canada.)</b></label>
            <input required type="text" name="{{ $request_type }}_due_date" required autocomplete="off"
...
<script type="text/javascript">
    $(function() {
        ...
        if(today.getHours() >= 16){
            var count = 4; // past 4pm
        }else{
            var count = 3; // before 4pm
        }
