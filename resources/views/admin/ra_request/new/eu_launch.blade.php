<?php $request_type = 'eu_launch'; ?>

<form method="POST" action="{{ route('ra_request.add_eu_launch') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_california">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">EU LAUNCH (CPNP)</p>
        ...
        <div class="form-group">
            <label>Requested Due Date: <b style="color: #b91d19">*</b> <b style="color: #b91d19">(The request will take 30 business days to complete after the CPNP submission by RA marked as “PENDING (3rd Party).")</b></label>
