<?php $request_type = 'latam_launch'; ?>

<form method="POST" action="{{ route('ra_request.add_latam_launch') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_iio">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">LATAM LAUNCH (IIO)</p>
        ...
        <div class="form-group">
            <label>Requested Due Date: <b style="color: #b91d19">*</b> <b style="color: #b91d19">(Select from the calendar)</b></label>
