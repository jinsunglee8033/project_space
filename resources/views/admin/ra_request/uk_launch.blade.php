...
<form method="POST" action="{{ route('ra_request.edit_uk_launch', $ra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_cpnp">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">UK LAUNCH</p>
            ...
            <div class="form-group">
                <label>Requested Due Date: <b style="color: #b91d19">(The request will take 30 business days to complete after the SCPN request submission by RA marked as “PENDING (3rd Party).”)</b></label>
            ...
            <div style="background-color: #e9e9e9; padding: 10px 10px 10px 10px; margin: 0 0 10px 0;">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="cpnp_stage">
                        ...
                        <option value="3. Final UK artwork" {{ $data[0]->cpnp_stage == '3. Final UK artwork' ? 'selected' : '' }} >3. Final UK artwork</option>
                        <option value="4. SCPN initiative" {{ $data[0]->cpnp_stage == '4. SCPN initiative' ? 'selected' : '' }} >4. SCPN initiative</option>
                        <option value="5. SCPN completed" {{ $data[0]->cpnp_stage == '5. SCPN completed' ? 'selected' : '' }} >5. SCPN completed</option>
                    </select>
                </div>
