...
<form method="POST" action="{{ route('ra_request.edit_latam_launch', $ra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_cnf">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">LATAM LAUNCH</p>
        ...
        <?php endif; ?>
            ...
            <div class="form-group">
                <label>Upload Artwork: <b style="color: #b91d19">(20MB Max)</b></label>
