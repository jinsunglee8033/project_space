...
<form method="POST" action="{{ route('ra_request.edit_label_review', $ra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="label_review">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">LABEL REVIEW</p>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="formula_review" class="form-control" <?php if ($data[0]->formula_review == 'on') echo "checked" ?> style="margin: 2px 0px 0px 0px;">
            </div>
