...
<section class="section">
    <div class="section-header">
        <h1>RA Request Overview</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item active">RA Request Overview</div>
        </div>
    </div>
    <div class="section-body">

        @include('admin.ra_request.flash')
        @include('admin.ra_request._filter')
                            ...
                            <div class="col-md-4" style="border-right:1px solid #eee; padding: 0px 0px 0px 0px;">
                                <div class="form-group">
                                    ...
                                    <div style="padding-top: 15px;">
                                        <a href="{{ url('admin/ra_request/'. $project->project_id .'/edit') }}">
                            ...
                            <div class="col-md-8 asset_scroll">
                                <div class="row" style="font-size: 12px;">
                                    <div class="col-sm-12" style="padding: 0px 0px 0px 2px;">
                                        ...
                                        <?php $assets = \App\Repositories\Admin\RaRequestRepository::get_ra_request_type($project->id); ?>
                                        <?php if(!empty($assets)){
