...
<section class="section">
    <div class="section-header">
        <h1>MM Request Overview</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item active">MM Request Overview</div>
        </div>
    </div>
    <div class="section-body">

        @include('admin.mm_request.flash')
        @include('admin.mm_request._filter')
...
{{--                                    class="close"--}}
{{--                                    data-id=""--}}
{{--                                    data-task-id="{{ $project->task_id }}"--}}
{{--                                    onclick="delete_request($(this));">--}}
                        ...
                        <div class="card-body" style="display: flex;">
                            <div class="col-md-4" style="border-right:1px solid #eee; padding: 0px 0px 0px 0px;">
                                <div class="form-group">
                                    ...
                                    <div style="padding-top: 15px;">
                                        <a href="{{ url('admin/mm_request/'. $project->project_id .'/edit') }}">
                            ...
                            <div class="col-md-8 asset_scroll">
                                <div class="row" style="font-size: 12px;">
                                    ...
                                    <?php $assets = \App\Repositories\Admin\MmRequestRepository::get_mm_request_type($project->id); ?>
                                        <?php if(!empty($assets)){
