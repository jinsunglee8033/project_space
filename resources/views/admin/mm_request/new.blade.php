...
<form method="POST" action="{{ route('mm_request.edit_new', $mm_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="new">
        ...
        <?php if(auth()->user()->role == 'Admin' || auth()->user()->team == 'MDM') { ?>
            ...
            <div style="margin: -20px 0 0px 10px; padding: 0px 0 0px 0;">
                ...
                <label style="font-size:; font-weight:100; medium; color: #b91d19; padding: 22px 0 0 20px;">* Click to indicate the start of work.</label>
            </div>

        <?php }?>
        <?php }?>

        <p style="color: #222; text-align: center; font-weight: bold;">NEW</p>
