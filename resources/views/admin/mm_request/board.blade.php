...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>MM Request Status Board</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">MM Request Status Board</div>
            </div>
        </div>

        <div class="section-body">

            @include('admin.mm_request._filter_board')
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($task_list_action_requested as $task)
                        ...
                        <div class="card" style="{{$late_css}}">
                            <a href="{{ url('admin/mm_request/'. $task->project_id .'/edit#'.$task->mm_request_type_id)}}" style="text-decoration: none;">
...
{{--                                            </div>--}}
                                            ...
                                            <?php if($task->request_type == 'new'){
                                                $bg_type = '#D733FF';
                                            }else if($task->request_type == 'update'){
                                                $bg_type = '#0C67EA';
                                            }else if($task->request_type == 'dimensions'){
                                                $bg_type = '#FF9331';
                                            }else if($task->request_type == 'price'){
                                                $bg_type = '#FF332E';
                                            }else{
                                                $bg_type = '#e3a300';
                                            }
                                            ...
                                            <div style="float:left; padding-left: 10px; color: {{$bg_type}};">
                                                {{ strtoupper($task->request_type) }} | {{$task->mm_request_type_id}}
                                            </div>
...
{{--                                            </div>--}}
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($task_list_action_completed as $task)
                        ...
                        <div class="card">
                            <a href="{{ url('admin/mm_request/'. $task->project_id .'/edit#'.$task->mm_request_type_id)}}" style="text-decoration: none;">
                                <div class="card-body" style="margin: 0px -5px -25px -5px;">
                                    <div class="media" style="padding-bottom: 0px;">
                                        <div class="form-group" style="width: 100%;">
