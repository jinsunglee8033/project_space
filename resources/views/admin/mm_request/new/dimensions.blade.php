<?php $request_type = 'dimensions'; ?>

<form method="POST" action="{{ route('mm_request.add_dimensions') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="dimensions">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">DIMENSIONS & LOGISTICS</p>
                ...
                <div class="col-md">
                    <div class="form-check" style="padding-left: 0px;">
                        <input  type="checkbox"
                                ...
                                value="{{ $value->name }}" id="dimension_{{ $value->name }}"
                        >
                        <label class="form-check-label " for="dimension_{{ $value->name }}">
                            {{ $value->name }}
                        </label>
                    </div>
                </div>
