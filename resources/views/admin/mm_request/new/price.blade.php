<?php $request_type = 'price'; ?>

<form method="POST" action="{{ route('mm_request.add_price') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="price">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">PRICE</p>

        <div class="form-group">
            <label>Request Detail: <b style="color: #b91d19">*</b> (Please ensure that the effective date for the price change is included.)</label>
                ...
                <div class="col-md">
                    <div class="form-check" style="padding-left: 0px;">
                        <input  type="checkbox"
                                ...
                                value="{{ $value->name }}" id="price_{{ $value->name }}"
                        >
                        <label class="form-check-label " for="price_{{ $value->name }}">
                            {{ $value->name }}
                        </label>
                    </div>
                </div>
