<?php $request_type = 'update'; ?>

<form method="POST" action="{{ route('mm_request.add_update') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="update">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">UPDATE</p>
                ...
                <div class="col-md">
                    <div class="form-check" style="padding-left: 0px;">
                        <input  type="checkbox"
                                ...
                                value="{{ $value->name }}" id="update_{{ $value->name }}"
                        >
                        <label class="form-check-label " for="update_{{ $value->name }}">
                            {{ $value->name }}
                        </label>
                    </div>
                </div>
