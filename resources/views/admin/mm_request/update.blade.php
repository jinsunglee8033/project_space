...
<form method="POST" action="{{ route('mm_request.edit_update', $mm_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="update">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">UPDATE</p>
