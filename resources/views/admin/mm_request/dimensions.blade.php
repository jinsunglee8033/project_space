...
<form method="POST" action="{{ route('mm_request.edit_dimensions', $mm_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="dimensions">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">DIMENSIONS & LOGISTICS</p>
