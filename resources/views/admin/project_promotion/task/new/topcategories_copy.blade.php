...
<form method="POST" action="{{ route('campaign.add_topcategories_copy') }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
    <label>Deadline Date: (Lead Time 7 Days)<span class="req" title="Required"> *</span></label>
    <input type="text" name="{{ $asset_type }}_launch_date" id="launch_date" required autocomplete="off"
