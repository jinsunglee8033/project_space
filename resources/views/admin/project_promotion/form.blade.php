...
@section('content')
    ...
    if (!empty($project)){
        ...
        $status = 'active';
        $second = 'General Project Manage';
        $third = 'Create General Project';
    }
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <label>Team</label>
                                            <select id="firstSelect" class="form-control @error('team') is-invalid @enderror @if (!$errors->has('team') && old('team')) is-valid @endif"
                                                    name="team" required>
                                                ...
                                                @else
                                                    @foreach ($teams as $value)
                                                        <option value="{{ $value }}" {{ $value == old('team') ? 'selected' : '' }}>
                                                            {{ $value }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="form-group">
                                            <label>Brand</label>
                                            @if ($brand)
                                                <select id="secondSelect" name="brand" required
                                                        class="form-control @error('brand') is-invalid @enderror @if (!$errors->has('brand') && old('brand')) is-valid @endif" >
                                                    <option value="{{ $brand }}" selected>
                                                        {{ $brand }}
                                                    </option>
                                                </select>
                                            @elseif(empty(old('brand')))
                                                <select id="secondSelect" name="brand" required
                                                        class="form-control @error('brand') is-invalid @enderror @if (!$errors->has('brand') && old('brand')) is-valid @endif" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="target_date" id="target_date" placeholder="Target Date" autocomplete="off" required
                                ...
                                <div class="card-footer text-right">
                                    <?php if ($status == 'active') { ?>
                                        <button class="btn btn-primary">{{ empty($project) ? __('Create') : __('Save Changes') }}</button>
                                    <?php } ?>
                                </div>
                            </div>
                        </form>
...
{{--    <?php endif; ?>--}}
    ...
    <script>
        ...
        firstSelect.addEventListener('change', function() {
            ...
            if (selectedOption === 'Select') {
            ...
            }else if (selectedOption === 'KISS Nail') {
                const option1 = document.createElement('option');
                option1.text = 'Gold Finger';
                option1.value = 'Gold Finger';
                const option2 = document.createElement('option');
                option2.text = 'imPRESS';
                option2.value = 'imPRESS';
            ...
            } else if (selectedOption === 'KISS Lash') {
                const option1 = document.createElement('option');
                option1.text = 'Falscara';
                option1.value = 'Falscara';
                const option2 = document.createElement('option');
                option2.text = 'imPRESS';
                option2.value = 'imPRESS';
                const option3 = document.createElement('option');
                option3.text = 'Lash Couture';
                option3.value = 'Lash Couture';
                const option4 = document.createElement('option');
                option4.text = 'MLBB';
                option4.value = 'MLBB';
                const option5 = document.createElement('option');
                option5.text = 'Looks So Natural';
                option5.value = 'Looks So Natural';
                const option6 = document.createElement('option');
                option6.text = 'So Wispy';
                option6.value = 'So Wispy';
                const option7 = document.createElement('option');
                option7.text = 'Kiss';
                option7.value = 'Kiss';
                const option8 = document.createElement('option');
                option8.text = 'Daphne Collection';
                option8.value = 'Daphne Collection';
                const option9 = document.createElement('option');
                option9.text = 'Filter Lashes';
                option9.value = 'Filter Lashes';
                const option10 = document.createElement('option');
                option10.text = 'Sister Nature';
                option10.value = 'Sister Nature';
                secondSelect.add(option1);
                secondSelect.add(option2);
                secondSelect.add(option3);
                ...
                secondSelect.add(option9);
                secondSelect.add(option10);
            } else if (selectedOption === 'Hair Care') {
                const option1 = document.createElement('option');
                option1.text = 'Broadway';
                option1.value = 'Broadway';
                const option2 = document.createElement('option');
                option2.text = 'Kiss Colors & Care';
                option2.value = 'Kiss Colors & Care';
                const option3 = document.createElement('option');
                option3.text = 'Kiss New York';
                option3.value = 'Kiss New York';
                const option4 = document.createElement('option');
                option4.text = 'Kiss';
                option4.value = 'Kiss';
                secondSelect.add(option1);
                ...
                secondSelect.add(option3);
                secondSelect.add(option4);
            } else if (selectedOption === 'Appliance') {
                const option1 = document.createElement('option');
                option1.text = 'Red';
                option1.value = 'Red';
                const option2 = document.createElement('option');
                option2.text = 'Red Pro';
                option2.value = 'Red Pro';
                const option3 = document.createElement('option');
                option3.text = 'Hot Beauty';
                option3.value = 'Hot Beauty';
                const option4 = document.createElement('option');
                option4.text = 'Kiss';
                option4.value = 'Kiss';
                secondSelect.add(option1);
