<form method="GET" action="{{ route('npd_design_request.board') }}">
    <div class="form-row" style="background-color: white; margin: -16px 0px 0px 0px; padding: 0px 0px 0px 12px;">
        ...
        <div class="form-group col-md-1" style="max-width: 12.666%;" >
            <div class="text-small font-600-bold" style="color: #D733FF;"><i class="fas fa-circle"></i> Urgent</div>
            <div class="text-small font-600-bold" style="color: #0C67EA;"><i class="fas fa-circle"></i> Normal</div>
        </div>
