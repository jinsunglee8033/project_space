<?php $task_type = 'legal_request'; ?>

<form method="POST" action="{{ route('project.add_legal_request') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <h5 style="text-align: center;">Please Click the "Create" button to initiate a <b style="color: #b91d19;">Legal Request</b></h5>
    </div>
