...
<div class="form-group">
    ...
    <h5 style="text-align: center;">Please Click the "Create" button to initiate a <b style="color: #b91d19;">Display Request</b></h5>
</div>

<div class="form-group">
    <a href="{{ url('admin/display_request/'.$project->id.'/edit') }}">
