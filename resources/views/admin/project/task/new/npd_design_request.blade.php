...
<form method="POST" action="{{ route('project.add_npd_design_request') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <h5 style="text-align: center;">Please Click the "Create" button to initiate a <b style="color: #b91d19;">NPD Design Request</b></h5>
    </div>
