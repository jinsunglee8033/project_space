...
<form method="POST" action="{{ route('qra_request.edit_document_support', $qra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="document_support">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">DOCUMENT SUPPORT</p>
