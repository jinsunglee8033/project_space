...
<form method="POST" action="{{ route('qra_request.edit_registration_cpnp', $qra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_cpnp">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">REGISTRATION CPNP</p>
