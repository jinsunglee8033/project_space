<?php $request_type = 'registration_iio'; ?>

<form method="POST" action="{{ route('qra_request.add_registration_iio') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_iio">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">REGISTRATION IIO</p>
