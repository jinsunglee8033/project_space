<?php $request_type = 'registration_cnf'; ?>

<form method="POST" action="{{ route('qra_request.add_registration_cnf') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_cnf">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">REGISTRATION CNF</p>
