<?php $request_type = 'registration_smarterx'; ?>

<form method="POST" action="{{ route('qra_request.add_registration_smarterx') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_smarterx">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">REGISTRATION SMARTERX</p>
