<?php $request_type = 'formulation_prescreen'; ?>

<form method="POST" action="{{ route('qra_request.add_formulation_prescreen') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="formulation_prescreen">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">FORMULATION PRESCREEN</p>
