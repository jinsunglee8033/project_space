<?php $request_type = 'artwork_contents'; ?>

<form method="POST" action="{{ route('qra_request.add_artwork_contents') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="artwork_contents">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">ARTWORK CONTENTS</p>
