<?php $request_type = 'registration_california'; ?>

<form method="POST" action="{{ route('qra_request.add_registration_california') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_california">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">REGISTRATION CALIFORNIA</p>
