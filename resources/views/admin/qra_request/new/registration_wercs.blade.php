<?php $request_type = 'registration_wercs'; ?>

<form method="POST" action="{{ route('qra_request.add_registration_wercs') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_wercs">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">REGISTRATION WERCS</p>
