<?php $request_type = 'document_support'; ?>

<form method="POST" action="{{ route('qra_request.add_document_support') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="document_support">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">DOCUMENT SUPPORT</p>
