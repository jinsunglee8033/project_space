<?php $request_type = 'artwork_review'; ?>

<form method="POST" action="{{ route('qra_request.add_artwork_review') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="artwork_review">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">ARTWORK REVIEW</p>
