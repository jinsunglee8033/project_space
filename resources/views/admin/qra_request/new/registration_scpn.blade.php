<?php $request_type = 'registration_scpn'; ?>

<form method="POST" action="{{ route('qra_request.add_registration_scpn') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_scpn">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">REGISTRATION SCPN</p>
