...
<form method="POST" action="{{ route('qra_request.edit_registration_california', $qra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="registration_california">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">REGISTRATION CALIFORNIA</p>
