...
<form method="POST" action="{{ route('qra_request.edit_artwork_review', $qra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="artwork_review">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">ARTWORK REVIEW</p>
