...
<form method="POST" action="{{ route('qra_request.edit_artwork_contents', $qra_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="artwork_contents">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">ARTWORK CONTENTS</p>
