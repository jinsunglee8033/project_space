<?php $request_type = 'claim'; ?>

<form method="POST" action="{{ route('legal_request.add_claim') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="claim">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">CLAIM</p>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="{{ $request_type }}_request_category" onchange="other_request_category($(this))" required>
                ...
                <?php foreach($claim_categories as $val): ?>
...
{{--                      name="{{ $request_type }}_request_description" required></textarea>--}}
        ...
        <div class="form-group urgent_due_date" hidden>
            ...
            <input required type="text" name="{{ $request_type }}_due_date_urgent" id="due_date_urgent" autocomplete="off"
                   class="form-control"
                ...
                <div class="col-md">
                    <div class="form-check" style="padding-left: 0px;">
                        <input  type="checkbox"
                                ...
                                value="{{ $value }}" id="claim_{{$value}}"
                        >
                        <label class="form-check-label" for="claim_{{ $value }}">
                            {{ $value }}
                        </label>
                    </div>
                </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('input[id="due_date_urgent"]').daterangepicker({
