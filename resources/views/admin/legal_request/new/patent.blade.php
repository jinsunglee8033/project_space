<?php $request_type = 'patent'; ?>

<form method="POST" action="{{ route('legal_request.add_patent') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="patent">
        <p style="color: #b91d19; text-align: center; font-weight: bold;">PATENT</p>
                ...
                <div class="col-md">
                    <div class="form-check" style="padding-left: 0px;">
                        <input  type="checkbox"
                                ...
                                value="{{ $value }}" id="patent_{{$value}}"
                        >
                        <label class="form-check-label " for="patent_{{ $value }}">
                            {{ $value }}
                        </label>
                    </div>
                </div>
