...
<form method="POST" action="{{ route('legal_request.edit_claim', $legal_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="claim">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">CLAIM</p>
