...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Legal Request Status Board</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Legal Request Status Board</div>
            </div>
        </div>

        <div class="section-body">

            @include('admin.legal_request._filter_board')
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($task_list_action_requested as $task)
                        ...
                        <div class="card" style="{{$late_css}}">
                            <a href="{{ url('admin/legal_request/'. $task->project_id .'/edit#'.$task->legal_request_type_id)}}" style="text-decoration: none;">
...
{{--                                            </div>--}}
                                            ...
                                            <?php if($task->request_type == 'trademark'){
                                                $bg_type = '#D733FF';
                                            }else if($task->request_type == 'patent'){
                                                $bg_type = '#0C67EA';
                                            }else if($task->request_type == 'claim'){
                                                $bg_type = '#FF9331';
                                            }else{
                                                $bg_type = '#FF332E';
                                            }
                                            ...
                                            <div style="float:left; padding-left: 10px; color: {{$bg_type}};">
                                                {{ strtoupper($task->request_type) }} | {{$task->legal_request_type_id}}
                                            </div>
