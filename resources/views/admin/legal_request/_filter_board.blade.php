<form method="GET" action="{{ route('legal_request.board') }}">
    <div class="form-row" style="background-color: white; margin: -16px 0px 0px 0px; padding: 0px 0px 0px 12px;">
        ...
        <div class="form-group col-md-2" style="max-width: 12.666%; margin-top: -10px;" >
            <div class="text-small font-600-bold" style="color: #D733FF;"><i class="fas fa-circle"></i> Trademark</div>
            <div class="text-small font-600-bold" style="color: #0C67EA;"><i class="fas fa-circle"></i> Patent</div>
            <div class="text-small font-600-bold" style="color: #FF9331;"><i class="fas fa-circle"></i> Claim</div>
            <div class="text-small font-600-bold" style="color: #FF332E;"><i class="fas fa-circle"></i> Contract</div>
        </div>
