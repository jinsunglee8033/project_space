...
<form method="POST" action="{{ route('legal_request.edit_patent', $legal_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="formulation_prescreen">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">PATENT</p>
