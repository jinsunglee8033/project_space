...
<section class="section">
    <div class="section-header">
        <h1>Legal Registration List View</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item">Legal Registration List View</div>
        </div>
    </div>

    <div class="section-body">

        @include('admin.legal_request._filter_request_list')
...
{{--                                        <th>Materials</th>--}}
                                    ...
                                    @foreach ($task_list as $task)
                                        <tr>
                                            <td>{{ $task->legal_request_type_id }}</td>
                                            <?php
...
{{--                                            <td>{{ mb_strimwidth($task->materials, 0,80, '...') }}</td>--}}
                                            ...
                                            <td>{{ $task->team }}</td>
                                            <td>
                                                <a href="{{ url('admin/legal_request/'. $task->project_id .'/edit#'.$task->legal_request_type_id)}}" class="btn btn-primary" style="border-radius: 20px; font-size: x-small;">
                                                    Detail
                                                </a>
                                            </td>
                                        </tr>
