...
<section class="section">
    <div class="section-header">
        <h1>IVY NPD Planner Request Overview</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item active">IVY NPD Planner Request Overview</div>
        </div>
    </div>
    <div class="section-body">

        @include('admin.npd_planner_request.flash')
        @include('admin.npd_planner_request._filter_index_ivy')
                        ...
                        <div class="card-body" style="display: flex;">
                            <div class="col-md-4" style="border-right:1px solid #eee; padding: 0px 0px 0px 0px;">
                                <div class="form-group">
                                    ...
                                    <div style="padding-top: 15px;">
                                        <a href="{{ url('admin/npd_planner_request/'. $project->project_id .'/edit') }}">
                            ...
                            <div class="col-md-8 asset_scroll">
                                <div class="row" style="font-size: 12px;">
                                    ...
                                    <?php $assets = \App\Repositories\Admin\TaskTypeNpdPlannerRequestRepository::get_npd_planner_request_type($project->id); ?>
                                        <?php if(!empty($assets)){
