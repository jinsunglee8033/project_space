...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>IVY NPD Planner Request Status Board</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">IVY NPD Planner Request Status Board</div>
            </div>
        </div>

        <div class="section-body">

            @include('admin.npd_planner_request._filter_board_ivy')

            <div class="row flex-nowrap" style="overflow-x: scroll; padding-top: 17px;">

                <div class="col-md-3">
                    <div class="card status_title">
                        <h5 class="status_name">ACTION REQUESTED (B2B)</h5>
                    </div>
                                    ...
                                    <div class="media" style="padding-bottom: 0px;">
                                        <div class="form-group" style="width: 100%;">
                                            ...
                                            <div class="text-sm-left text-muted" style="float:left; padding-left: 10px;">
                                                <?php if($task->decline_reason == 'P&L Revision Required') { ?>
                                                    <b style="color: #f186b7;">{{ strtoupper(str_replace('_', ' ', $task->decline_reason)) }}</b>
                                                <?php }else{ ?>
                                            ...
                                            <div style="float: right; color: #333333;" >
                                                ...
                                                <?php
                                                    if($task->decline_reason == 'P&L Revision Required') {
                                                        $revision_bg = '#fad7e7';
                                                    }else{
                                                        $revision_bg = '#ffc107';
                                                    }
                                                ...
                                                <button type="button" class="btn btn-icon" style="font-family: revert;
                                                            font-size: 13px; background-color: {{$revision_bg}};
                ...
                <div class="col-md-3">
                    <div class="card status_title">
                        <h5 class="status_name">IN PROGRESS (B2B)</h5>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="card status_title">
                        <h5 class="status_name">ACTION COMPLETE (SOM) </h5>
                    </div>

                    @foreach ($task_list_action_completed as $task)

                        <?php if(isset($task->uploaded_date)) {
                            $card_bg = ' ';
                        }else{
                            $card_bg = '#fad7e7';
                        }
