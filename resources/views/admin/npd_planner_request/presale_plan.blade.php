...
<form method="POST" action="{{ route('npd_planner_request.edit_presale_plan', $npd_planner_request_type_id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="price">
        ...
        <p style="color: #222; text-align: center; font-weight: bold;">Presale Plan</p>
            ...
            <div class="form-group">
                <label>Purpose:</label>
                <textarea class="form-control" name="purpose" style="height:60px;">{{ $data[0]->purpose }}</textarea>
            </div>

            <div class="form-group">
                <label>Promotion Conditions:</label>
                {!! Form::textarea('promotion_conditions', !empty($data[0]->promotion_conditions) ? $data[0]->promotion_conditions : null, ['class' => 'form-control summernote']) !!}
            </div>

            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Presale Start Date: <b style="color: #b91d19">(Select from the calendar)</b></label>
                        <input type="text" name="presale_start_date" id="{{ $npd_planner_request_type_id }}_presale_start_date" autocomplete="off"
                               class="form-control" required
                               value="{{ $data[0]->presale_start_date }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Presale End Date: <b style="color: #b91d19">(Select from the calendar)</b></label>
                        <input type="text" name="presale_end_date" id="{{ $npd_planner_request_type_id }}_presale_end_date" autocomplete="off"
                               class="form-control" required
                               value="{{ $data[0]->presale_end_date }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Promotion Start Date: <b style="color: #b91d19">(Select from the calendar)</b></label>
                        <input type="text" name="promotion_start_date" id="{{ $npd_planner_request_type_id }}_promotion_start_date" autocomplete="off"
                               class="form-control" required
                               value="{{ $data[0]->promotion_start_date }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Promotion End Date: <b style="color: #b91d19">(Select from the calendar)</b></label>
                        <input type="text" name="promotion_end_date" id="{{ $npd_planner_request_type_id }}_promotion_end_date" autocomplete="off"
                               class="form-control" required
                               value="{{ $data[0]->promotion_end_date }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Presale Initial Shipping Start Date: <b style="color: #b91d19">(Select from the calendar)</b></label>
                        <input type="text" name="presale_initial_shipping_start_date" id="{{ $npd_planner_request_type_id }}_presale_initial_shipping_start_date" autocomplete="off"
                               class="form-control" required
                               value="{{ $data[0]->presale_initial_shipping_start_date }}">
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('input[id="<?php echo $npd_planner_request_type_id;?>_presale_start_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        $('input[id="<?php echo $npd_planner_request_type_id;?>_presale_end_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        $('input[id="<?php echo $npd_planner_request_type_id;?>_promotion_start_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        $('input[id="<?php echo $npd_planner_request_type_id;?>_promotion_end_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
        });
        $('input[id="<?php echo $npd_planner_request_type_id;?>_presale_initial_shipping_start_date"]').daterangepicker({
            singleDatePicker: true,
            locale: {
                format: 'YYYY-MM-DD'
            },
