...
<section class="section">
    <div class="section-header">
        <h1>RED NPD Planner Request Overview</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item active">RED NPD Planner Request Overview</div>
        </div>
    </div>
    <div class="section-body">

        @include('admin.npd_planner_request.flash')
        @include('admin.npd_planner_request._filter_index_red')
