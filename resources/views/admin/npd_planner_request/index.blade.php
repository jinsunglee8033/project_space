...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Request Status Board (NPD Planner Request)</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">NPD Planner Request Request Status Board</div>
            </div>
        </div>

        <div class="section-body">

            @include('admin.npd_planner_request._filter')
            ...
            <div class="row flex-nowrap" style="overflow-x: scroll; padding-top: 17px;">
                ...
                <div class="col-md-3">
                    ...
                    @foreach ($task_list_action_requested as $task)
                        ...
                        <div class="card">
                            <a href="{{ url('admin/npd_planner_request/'. $task->project_id .'/edit#'.$task->task_id)}}" style="text-decoration: none;">
...
//                                            ?>
                                            ...
                                            <div class="text-sm-left text-muted" style="float:left; padding-left: 10px;">
                                                {{ date('m/d/y', strtotime($task->due_date_review))}}
                                            </div>
...
{{--                                            </div>--}}
                ...
                <div class="col-md-3">
                    <div class="card status_title">
                        <h5 class="status_name">REVISION</h5>
                    </div>
